...
--
-- Host: localhost
-- Generation Time: Mar 14, 2015 at 08:29 PM
...
INSERT INTO `donnation` (`id`, `description`, `amount`, `type`, `observations`, `last_state`, `current_state`, `created_at`, `updated_at`, `donnor_id`) VALUES
(4, 'Doacao Livros', 1, 'Paypal', 'Doei 284 livros', 'Help Pending', 'Help Sent', '2014-08-01', '2014-08-01', 6),
(5, 'Doacao de canecas', 2, 'Paypal', 'Doei as canecas            ', 'Payment Accepted', 'Help Pending', '2014-08-01', '2014-08-01', 6);

-- --------------------------------------------------------

--
-- Table structure for table `donnor`
--
...
--
-- Dumping data for table `donnor`
--

INSERT INTO `donnor` (`id`, `name`, `phone1`, `phone2`, `email`, `since`, `user_id`, `country`) VALUES
(3, 'Aderlei', '123', '123', 'aderleifilho@uol.com.br', '2014-08-01', 6, '31');
